...
switchSlider.addEventListener("click",()=> {
  ...
  switchSlider.addEventListener("mouseover", () => {
    switchSlider.style.translate = "0px -3px"
    switchSlider.style.opacity = "0.5"
    switchSlider.style.transition = "100ms"
})
    
switchSlider.addEventListener("mouseout", () => {
        switchSlider.style.translate = "0px 3px"
